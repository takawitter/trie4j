...
public abstract class AbstractImmutableTrieWikipediaSerializeTest{
	protected abstract Trie newTrie(Trie orig);

	@Test
	public void test() throws Exception{
		WikipediaTitles wt = new WikipediaTitles();
		Trie trie = newTrie(wt.insertTo(new TailPatriciaTrie(new ConcatTailBuilder())));
